...
namespace Proeve.Resources
{
    class Armies
    {
        ...
        public static void SetUpCharacters()
        {
            ...
            characters[(int)Character.Rank.Captain].Add(new Character(ArtAssets.TikiCaptainChip, AnimationAssets.TikiCaptain, 4, 1, Character.Rank.Captain, Character.Army.Tiki));
            ...
            characters[(int)Character.Rank.Soldier].Add(new Character(ArtAssets.TikiSoldierChip, AnimationAssets.TikiSoldier, 3, 1, Character.Rank.Soldier, Character.Army.Tiki));
